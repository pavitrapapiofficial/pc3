...
use PurpleCommerce\Support\Model\ResourceModel\Support\CollectionFactory as SupportCollectionFactory;
// @codingStandardsIgnoreEnd
use PurpleCommerce\Support\Model\ResourceModel\Support as ResourceSupport;
use PurpleCommerce\Support\Api\Data\SupportInterfaceFactory;
use Magento\Framework\Exception\CouldNotSaveException;
use Magento\Framework\Exception\CouldNotDeleteException;
use PurpleCommerce\Support\Api\SupportRepositoryInterface;
...
class SupportRepository implements SupportRepositoryInterface
{
     ...
     * @param SupportFactory $giftcertificateFactory
     * @param SupportInterfaceFactory $dataSupportFactory
     * @param SupportCollectionFactory $giftcertificateCollectionFactory
    ...
    public function __construct(
        ...
        SupportFactory $giftcertificateFactory,
        SupportInterfaceFactory $dataSupportFactory,
        SupportCollectionFactory $giftcertificateCollectionFactory,
    ...
    public function save(
        \PurpleCommerce\Support\Api\Data\SupportInterface $giftcertificate
    ) {
 ...
 */
    public function saveNew($rewardData)
    {
        ...
        if ($grandTotal > $rewardAmount) {
            ...
            $rewardInfo = $this->session->getSupportInfo();
            if (!$rewardInfo) {
                $amount = $rewardAmount;
                $rewardInfo = [];
                $rewardInfo = [
             ...
             $this->session->setSupportInfo($rewardInfo);
        } else {
            throw new \Magento\Framework\Exception\LocalizedException(
